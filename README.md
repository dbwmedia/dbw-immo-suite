...
*   **Optimierung**: Einstellungsseite für Import-Pfad komplett überarbeitet – Dropdown mit vorgeschlagenen Pfaden, „Pfad prüfen"-Button mit Live-AJAX-Validierung und Server-Info-Box.
